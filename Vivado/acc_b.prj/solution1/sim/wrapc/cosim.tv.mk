...
$(ObjDir)/acc_b_test.c_pre.c.tb.o : acc_b_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) acc_b_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/acc_b.c_pre.c.tb.o : acc_b.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) acc_b.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
