...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "acc_b.autotvin.dat"
	set constFileTvOut       "acc_b.autotvout.dat"
	set constFileHdlTvIn     "acc_b.autohdltvin.dat"
	set constFileHdlTvOut    "acc_b.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
