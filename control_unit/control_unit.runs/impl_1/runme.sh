...
HD_PWD='C:/Users/stevenlee/Documents/control_unit/control_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_unit.vdi -applog -m64 -messageDb vivado.pb -mode batch -source control_unit.tcl -notrace
