...
HD_PWD='C:/Users/stevenlee/Documents/control_unit/control_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_unit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source control_unit.tcl
